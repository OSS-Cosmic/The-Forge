...
typedef enum RendererApiFlags
{
    RENDERER_API_NONE_FLAG = 0,
#if defined(GLES)
    RENDERER_API_GLES_FLAG = (1 << RENDERER_API_GLES),
#endif
#if defined(DIRECT3D12)
    RENDERER_API_D3D12_FLAG  = (1 << RENDERER_API_D3D12),
#endif
#if defined(VULKAN)
    RENDERER_API_VULKAN_FLAG = (1 << RENDERER_API_VULKAN),
#endif
#if defined(DIRECT3D11)
    RENDERER_API_D3D11_FLAG = (1 << RENDERER_API_D3D11),
#endif
#if defined(METAL)
    RENDERER_API_METAL_FLAG = (1 << RENDERER_API_METAL),
#endif
//#if defined(ORBIS)
//    RENDERER_API_ORBIS_FLAG = (1 << RENDERER_API_ORBIS),
//#endif
//#if defined(PROSPERO)
...
#include "Common_3/Graphics/Interfaces/IShaderReflection.h"
...
// API functions
FORGE_RENDERER_API RendererApiFlags FORGE_CALLCONV avaliableAPIs();
