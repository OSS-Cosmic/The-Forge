...
{
    TSimdf32x4 value = tfSimd4fSplat(23.f);
    ...
    TSimdf32x4 value1 = tfSimd4fSplat(5.1f);
    ...
    TSimdf32x4 value2 = tfSimd4fLoadImmediate(5.1f, 1.0f, 2.0f, 3.0f);
